<html>
    ...
    <body>
        <div class="navbar"><!--navigation bar for navigating through the website and all it's functions... adapted from W3schools nav bar-->
          ...
          <div>
            <br>
            <form method="post" action="DeletePupilParent.php"><!--form to enter ID of pupil and parent relation you wish to delete-->
                  ...
                  <p>Warning! This will delete a pupil and parent relation permanently!</p>
        ...
        <?php
            ...
            */
            ...
            on the database
            */
            $sql = "DELETE FROM ParentsPupils WHERE relation = '$rid'"; //deletes pupil and parent relation from php database
        ...
        ?>
        <h2>See all Pupils and Parents relationships</h2><!--let's you see current relationships in order to make deleting easier-->
        <div>
        <table>
            <tr>
