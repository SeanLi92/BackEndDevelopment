<html>
    ...
    <body>
        <div class="navbar"><!--navigation bar for navigating through the website and all it's functions... adapted from W3schools nav bar-->
          ...
          <div>
            <br>
            <form method="post" action="DeleteParent.php"><!--form to enter ID of parent you wish to delete-->
                  ...
                  <p>Warning! This will delete a parent permanently!</p>
                  <p>Please delete relationship to pupil in PupilsParents first.</p>
        ...
        <?php
            ...
            */
            ...
            on the database
            */
            $sql = "DELETE FROM Parents WHERE parent_id = '$pid'"; //deletes parent from php database
        ...
        ?>
        <h2>See all Parents</h2><!--let's you view all paretns to make deleting easier-->
