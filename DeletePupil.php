<html>
    ...
    <body>
        <div class="navbar"><!--navigation bar for navigating through the website and all it's functions... adapted from W3schools nav bar-->
          ...
          <div>
            <br>
            <form method="post" action="DeletePupil.php"><!--form to enter ID of pupil you wish to delete-->
                  ...
                  <p>Warning! This will delete a pupil permanently!</p>
                  <p>Please delete relationship to parent in PupilsParents first.</p>
        ...
        <?php
            ...
            */
            ...
            on the database
            */
            $sql = "DELETE FROM Pupils WHERE pupil_id = '$pid'"; //deletes pupil from php database
