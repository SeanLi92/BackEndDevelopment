<html>
    ...
    <body>
        <div class="navbar"><!--navigation bar for navigating through the website and all it's functions... adapted from W3schools nav bar-->
          ...
          <div>
            <br>
            <form method="post" action="AddClass.php"><!--creates a form to add a new class that needs a name, year, and capacity-->
...
on the database
*/
    $sql = "INSERT INTO Classes (classname,class_year,capacity) VALUES ('$cname','$cyear','$ccap')"; //creates a new class based on the submitted information in AddClass.html
