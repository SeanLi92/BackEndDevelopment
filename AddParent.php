<html>
    ...
    <body>
        <div class="navbar"><!--navigation bar for navigating through the website and all it's functions... adapted from W3schools nav bar-->
          ...
          <div>
            <br>
            <form method="post" action="AddParent.php"><!--creates a form to add a new parent that needs a first name, last name, address, email, and telephone number-->
...
ini_set('display_errors', 1); //displays errors and helps figure out whta the errors are
...
on the database
*/
    $sql = "INSERT INTO Parents (parent_Fname,parent_Lname,address,email,telephone) VALUES ('$fname','$lname','$address','$email','$pphone')"; //creates a new parent based on the submitted information in AddParent.php form
