<html>
    ...
    <body>
        <div class="navbar"><!--navigation bar for navigating through the website and all it's functions... adapted from W3schools nav bar-->
          ...
          <div class = "bodform">
            <br>
            <form method="post" action="AddPupil.php"><!--creates a form to add a new pupil that needs a first name, last name, address, medical record, money, and class id-->
...
/*The isset() function checks whether a variable is set, which means that it has to be declared 
 and is not NULL. This function returns true if the variable
  exists and is not NULL, otherwise it returns false. */
...
/*mysqli_query() function accepts a string value representing a query as one of the parameters
and, executes/performs the given query on the database*/
    $sql = "INSERT INTO Pupils (class_id,pupil_Fname,pupil_Lname,address,medical_record,Dinner_Money) VALUES ('$Cid','$fname','$lname','$address','$MedRec','$DinMon')"; //creates a new pupil based on the submitted information in AddPupil.php form
